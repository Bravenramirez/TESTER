namespace Auto_Trader_Platform
{
    partial class Settings
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblStrategy.BackColor = SystemColors.ActiveBorder;
            lblStrategy.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
            lblStrategy.Location = new Point(582, 69);
            lblStrategy.Name = "lblStrategy";
            lblStrategy.Size = new Size(161, 25);
            lblStrategy.TabIndex = 18;
            lblStrategy.Text = "Current Strategy";
            // 
            // txtStrategy
            // 
            txtStrategy.Location = new Point(540, 115);
            txtStrategy.Name = "txtStrategy";
            txtStrategy.Size = new Size(248, 323);
            txtStrategy.TabIndex = 19;
            txtStrategy.Text = "";
            txtStrategy.TextChanged += txtStrategy_TextChanged;
            // 
            // Settings
            // 
        ...
        private RichTextBox txtStrategy;
    }
}
